...
const companies = [
    'TechCorp', 'DataFlow Inc', 'CloudSync', 'APIFirst Ltd', 'StreamlineHQ',
    'DevTools Pro', 'ScaleUp Systems', 'IntegrateNow', 'AutomateIt',
    'ConnectAPI', 'FlowState', 'BuildFast', 'CodeStream', 'DataBridge',
    'ServiceMesh', 'CloudNative', 'MicroService', 'EventStream', 'BatchPro',
    'RealTime Systems', 'EdgeCompute', 'ProcessFlow', 'WorkflowMax'
];
// Sample first and last names
const firstNames = [
    'Alex', 'Jordan', 'Taylor', 'Casey', 'Riley', 'Morgan', 'Avery', 'Quinn',
    'Drew', 'Blake', 'Cameron', 'Dakota', 'Emery', 'Finley', 'Harper',
    'Indigo', 'Jaden', 'Kendall', 'Logan', 'Marley', 'Nico', 'Parker',
    'River', 'Sage', 'Tatum', 'Val', 'Winter', 'Zion'
];
const lastNames = [
    ...
    const priceBooks = [
        {
            ...
            baseFee: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('99.00')),
            tier1Limit: 1000,
            tier1Price: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('0')),
            tier2Limit: 1000000,
            tier2Price: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('0.002')),
            tier3Price: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('0.001')),
            minCommit: 10000,
            minCommitFee: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('20.00')),
        },
        {
            name: 'Pro Plan',
            description: 'For growing businesses with higher usage',
            baseFee: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('199.00')),
            tier1Limit: 5000,
            tier1Price: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('0')),
            tier2Limit: 2000000,
            tier2Price: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('0.0015')),
            tier3Price: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('0.0008')),
            minCommit: 25000,
            minCommitFee: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('37.50')),
        },
        {
            name: 'Enterprise Plan',
            description: 'Custom pricing for large organizations',
            baseFee: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('499.00')),
            tier1Limit: 10000,
            tier1Price: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('0')),
            tier2Limit: 5000000,
            tier2Price: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('0.001')),
            tier3Price: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('0.0005')),
            minCommit: 100000,
            minCommitFee: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('100.00')),
        },
    ];
...
async function seedCustomers() {
    ...
    for (let i = 0; i < DEMO_CUSTOMERS_COUNT; i++) {
        ...
        const creditBalance = hasCreditBalance
            ? (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)(randomFloat(10, 500).toFixed(2)))
        ...
        customers.push({
            ...
            creditBalance,
            timezone: randomChoice(['UTC', 'America/New_York', 'America/Los_Angeles', 'Europe/London']),
        });
    }
...
async function seedContracts(customers) {
    ...
    for (const customer of customers) {
        ...
        const status = Math.random() < 0.9 ? 'ACTIVE' : randomChoice(['PAUSED', 'CANCELED']);
        contracts.push({
            ...
            discountRate: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)('0.2')), // 20% discount
...
async function seedUsageEvents(contracts) {
    ...
    for (const contract of contracts) {
        if (contract.status !== 'ACTIVE')
            continue; // Only generate usage for active contracts
        ...
        for (let day = 0; day < USAGE_DAYS; day++) {
            ...
            const eventsPerDay = Math.min(100, Math.max(1, Math.floor(dailyUsage / 10)));
                ...
                await prisma.usageEvent.create({
                    data: {
                        ...
                        metadata: {
                            ...
                            endpoint: randomChoice(['/api/v1/users', '/api/v1/data', '/api/v1/analytics', '/api/v1/reports']),
                        },
                    },
                });
                totalEvents++;
...
async function seedCredits(customers) {
    ...
    for (const customer of customersWithCredits) {
        ...
        credits.push({
            customerId: customer.id,
            amount: (0, shared_1.moneyToDecimalString)((0, shared_1.createMoney)(amount.toFixed(2))),
