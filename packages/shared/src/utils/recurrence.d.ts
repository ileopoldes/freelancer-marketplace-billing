 ...
 */
export declare function getNextBillingDates(rruleString: string, startDate: Date, count?: number): Date[];
/**
 * Get the next single billing date
 */
export declare function getNextBillingDate(rruleString: string, after?: Date): Date | null;
/**
 * Check if a date matches the recurrence rule
 */
export declare function dateMatchesRecurrence(rruleString: string, date: Date): boolean;
/**
 * Get all billing dates between two dates
 */
export declare function getBillingDatesBetween(rruleString: string, startDate: Date, endDate: Date): Date[];
/**
...
export declare const BillingRules: {
     ...
     * Custom interval
     */
    custom: (frequency: "DAILY" | "WEEKLY" | "MONTHLY" | "YEARLY", interval?: number) => string;
    /**
 ...
 */
export declare function intervalToRRule(interval: 'DAY' | 'WEEK' | 'MONTH' | 'YEAR', intervalCount?: number, startDate?: Date): string;
