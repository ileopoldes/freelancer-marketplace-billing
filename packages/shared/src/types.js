...
exports.CreateInvoiceSchema = exports.RecordUsageSchema = exports.CreateSubscriptionSchema = exports.CreatePriceSchema = exports.CreateProductSchema = exports.CreateCustomerSchema = void 0;
...
exports.CreatePriceSchema = zod_1.z.object({
    ...
    billingScheme: zod_1.z.enum(['PER_UNIT', 'TIERED', 'VOLUME', 'GRADUATED']).default('PER_UNIT'),
